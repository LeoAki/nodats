...
$.extend($.validator, {
	...
	messages: {
		...
		email: "Por favor ingrese una dirección de correo electronico valida.",
		url: "Por favor ingrese una dirección web valida.",
		...
		creditcard: "Por favor ingrese un numero de tarjeta de crédito valida.",
		equalTo: "Por favor ingrese el mismo valor nuevamente.",
		accept: "Please enter a value with a valid extension.",
		maxlength: $.validator.format("Por favor ingrese no mas de {0} caracteres."),
