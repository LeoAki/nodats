...
class registroalumnoModel extends Model {
    ...
    private $p211;private $p212;private $p213;
    private $promedio2;
    ...
    public function getP213() {
        return $this->p213;
    }

    public function setP213($p213) {
        $this->p213 = $p213;
    }
    ...
    public function ListaAlumnoSeccion($seccion) {
        $seccion = (int) $seccion;
        $list= $this->_db->query('
            SELECT ase.nroorden, ae.paterno, ae.materno, ae.nombres,ase.idalumnoseccion
